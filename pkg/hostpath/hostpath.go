...
func NewHostPathDriver(cfg Config, lvm *LVM) (*hostPath, error) {
	if cfg.DriverName == "" {
...
// 		// 	return nil, err
// 		// }
// 		if err := hp.lvm.CreateVolume(); err != nil {
// 			return nil, fmt.Errorf("failed to create volume: %w", err)
// 		}
// 	case state.BlockAccess:
// 		return nil, status.Error(codes.Unimplemented, "block access not supported")
...
// 	vol, err := hp.lvm.GetVolumeByID(volID)
// 	if err != nil {
...
// 		return status.Error(codes.Unimplemented, "block access not supported")
// 		// volPathHandler := volumepathhandler.VolumePathHandler{}
// 		// path := hp.getVolumePath(volID)
...
// 		return err
// 	}
// 	if err := hp.lvm.DeleteVolume(volID); err != nil {
// 		return err
// 	}
