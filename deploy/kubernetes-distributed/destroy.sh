...
# Using app.kubernetes.io/instance: lvm.csi.justinsb.com and app.kubernetes.io/part-of: csi-driver-host-path labels to identify the installation set
#
...
kubectl delete all --all-namespaces -l app.kubernetes.io/instance=lvm.csi.justinsb.com,app.kubernetes.io/part-of=csi-driver-host-path --wait=true
kubectl delete role,clusterrole,rolebinding,clusterrolebinding,serviceaccount,storageclass,csidriver --all-namespaces -l app.kubernetes.io/instance=lvm.csi.justinsb.com,app.kubernetes.io/part-of=csi-driver-host-path --wait=true
